...
\end{align}
One can easily verify that minimizers of $\mathcal{E}_{\mathrm{heat}}$ are weak solutions of \cref{heat_discrete} by computing the Euler–Lagrange equation~(\Cref{EL_eq}).
